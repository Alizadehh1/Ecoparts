...
$.extend($.easing, {
    ...
    (Riode.defaults = {
        ...
        minipopup: {
            ...
            template:
                '<div class="minipopup-box"><p class="minipopup-title">{{message}}</p><div class="product product-purchased {{productClass}} mb-0"><figure class="product-media"><a href="~/assets/{{imageLink}}"><img src="~/assets/{{imageSrc}}" alt="product" width="90" height="90"></a></figure><div class="product-detail"><a href="~/assets/{{nameLink}}" class="product-name">{{name}}</a>{{detailTemplate}}</div></div>{{actionTemplate}}</div>',
        },
        popup: {
            removalDelay: 350,
            callbacks: {
